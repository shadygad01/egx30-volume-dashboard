  ...
  return <DashboardLayout>
    <div className="min-h-screen bg-[#071018] text-slate-100 -m-4 p-5 lg:p-8">
      ...
      <main className="mx-auto max-w-[1500px]">
        ...
        {activeTab === "Stock detail" && <StockDetail detail={detail.data} isLoading={detail.isLoading} selectedSymbol={selectedSymbol} setSelectedSymbol={setSelectedSymbol} />}
